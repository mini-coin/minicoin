...
// Copyright (c) 2013 The Minicoin developers
...
uint256 hashGenesisBlock("0x395a11313613306b985e66c13b3aed27a5b084948affdf1ae991229d798a1277");
static const unsigned int timeGenesisBlock = 1390497447           ;
...
static const int64 nTargetSpacing = 15; // 15 seconds  //MINI:block generation
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 20 blocks  //MINI:
/*
 * 1-10000   20000
10001-20000  10000
20001-30000  5000
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    int64 nSubsidy = 625 * COIN;
    if(nHeight <= 10000)
    {
    nSubsidy = 20000 * COIN;//MINI:
     }
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "MINI coin start!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x2b53cc9b931d3ba2c740643b6295dc6a0519b30e5960a0ad7907fc6363ea0785"));
...
unsigned char pchMessageStart[4] = { 0x2d, 0x43, 0xa5, 0xae };//MINI:
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MinicoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MinicoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MinicoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("minicoin-miner");
    ...
    try { loop {
        ...
        printf("Running MinicoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("MinicoinMiner terminated\n");
        throw;
    }
}
