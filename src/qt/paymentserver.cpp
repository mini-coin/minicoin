...
const QString BITCOIN_IPC_PREFIX("minicoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click minicoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start minicoin: click-to-pay handler");
    else
...
{
    // clicking on minicoin: URLs creates FileOpen events on the Mac:
